...
| Browser loss during discovery | Camofox/browser disappears while cards are being collected. | The discovery sidecar is saved as `in_progress`, is never reused as complete, and a subsequent run starts safely. |
